...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0021-sem", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0021-sem", "DT0021-sem" )

  DR_drifting_baseline( "DR0021-sem", "CA0021-sem" )
  FE_historia_baseline( "FE0021-sem", "DR0021-sem" )

  TS_strategy_baseline_202109( "TS0031-sem", "FE0021-sem" )

  HT_tuning_baseline( "HT0031-sem", "TS0031-sem" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0031-sinUS", c("HT0031-sem","TS0031-sem") )
