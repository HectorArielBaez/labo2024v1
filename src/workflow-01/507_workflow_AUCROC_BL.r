...
corrida_guantesblancos_202109_AUC <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0921", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0921", "DT0921" )

  DR_drifting_guantesblancos( "DR0921", "CA0921" )
  FE_historia_guantesblancos( "FE0921", "DR0921" )

  TS_strategy_guantesblancos_202109( "TS0921", "FE0921" )

  HT_tuning_AUCROC( "HT0921", "TS0921" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0921", c("HT0921","TS0921") )
...
corrida_guantesblancos_202107_AUC <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0922", "FE0921" )

  HT_tuning_AUCROC( "HT0922", "TS0922" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0922", c("HT0922", "TS0922") )
...
corrida_guantesblancos_202109_AUC( "gb01_AUC_BL" )


# Luego partiendo de  FE0001

corrida_guantesblancos_202107_AUC( "gb02_AUC_BL" )
